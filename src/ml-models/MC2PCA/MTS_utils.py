...
def load_all_csv(root_path, seq_length):
    ...
    parti_point = int(0.8*All_Series.shape[0])
    train_data = All_Series[:parti_point, :, :]
    test_data = All_Series[parti_point:, :, :]
...
class CreateDataset():
    ...
    def __init__(self):
        data, label   = load_all_csv(r"/Users/zhouz/Project/VM_Workload_Predictor/fastStorage/VMmonitoring", seq_length=112)
